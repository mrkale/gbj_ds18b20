/*
  NAME:
  Configure DS18B20 temperature sensors on the one-wire bus.

  DESCRIPTION:
  The sketch updates scratchpad of each active sensors with alarm values
  and resolution.
...
void setup()
{
  ...
  while (ds.isSuccess(ds.sensors()))
  {
    ...
    // Store and display sensor's configuration
